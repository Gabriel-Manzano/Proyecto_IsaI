    ...
    <div class="container mt-5 p-4 shadow rounded">
        ...
        <div class="panelControl p-4 shadow-sm rounded d-flex flex-column align-items-center">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Hoteles Registrados</h5>
                        <p class="card-text">{{ $numeroHoteles }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4">
                <a href="{{ route('reporte.hoteles.pdf') }}" class="btn btn-danger">Exportar PDF</a>
                <a href="{{ route('reporte.hoteles.excel') }}" class="btn btn-success">Exportar Excel</a>
            </div>
        </div>
