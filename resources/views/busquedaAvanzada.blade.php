    ...
    <div class="filter-container">
        <form method="GET" action="{{ route('busqueda') }}">
            ...
            <select name="amenities[]" multiple>
                <option value="Piscina" {{ in_array('Piscina', (array) request('amenities', [])) ? 'selected' : '' }}>
                    Piscina</option>
                <option value="WiFi" {{ in_array('WiFi', (array) request('amenities', [])) ? 'selected' : '' }}>WiFi
                </option>
                <option value="Spa" {{ in_array('Spa', (array) request('amenities', [])) ? 'selected' : '' }}>Spa
                </option>
                <option value="Gimnasio" {{ in_array('Gimnasio', (array) request('amenities', [])) ? 'selected' : '' }}>
                    Gimnasio</option>
            </select>
            ...
            <input type="number" name="distancia" placeholder="Distancia al centro (m)"
